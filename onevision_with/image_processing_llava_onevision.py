...
class LlavaOnevisionImageProcessor(BaseImageProcessor):
    ...
    #将图像划分为patch,并返回原始图像+所有patch的列表
    ...
    #在batch中填充图像的维度,使得所有图像都具有相同的patch数量
