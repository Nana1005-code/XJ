...
class LlavaOnevisionPipeline:
    ...
    def run(self, image_path, question, api_tips):
        ...
        answer, predicted_label, probabilities = self.generate_answer_and_score(aligned_input, input_ids)
        return {"answer": answer, "predicted_label": predicted_label, "probabilities": probabilities}
...
if __name__ == "__main__":
    ...
    question = "问题：这张图片中的人是男性还是女性？选项：A.男性 B.女性 C.未知"
    ...
    result = pipeline.run(image_path, question, api_tips)
